...
export default function TeoriaScreen() {
  return (
    <ScrollView style={styles.container}>
      ...
      <Link href="../capitolo2"><Text style={styles.link}>2. Ciclo di Vita del Software</Text></Link>
      <Link href="../capitolo3"><Text style={styles.link}>3. Tecniche Statiche</Text></Link>
      <Link href="../capitolo4"><Text style={styles.link}>4. Tecniche di Test</Text></Link>
      <Link href="../capitolo5"><Text style={styles.link}>5. Gestione dei Test</Text></Link>
      <Link href="../capitolo6"><Text style={styles.link}>6. Strumenti di Supporto</Text></Link>
